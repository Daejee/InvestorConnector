...
**반드시 준수할 작성 스타일:**
- 정중어 절대 사용 금지: "했습니다", "입니다", "되었습니다" → "함", "임", "됨"
- 축약형 문체 필수: "진행되었습니다" → "진행", "관심을 보였습니다" → "관심 보임"
- 조사 최대한 생략: "회사는", "투자자가" → "회사", "투자자"
- 수식어구 삭제: "~에 대한", "~와 관련하여", "~에 있어서" 모두 삭제

**정확한 예시:**
올바른 형태: "금주미팅 총2회 진행. 첫미팅은 미래에셋자산운용의 이원준 투자자와 본사 대면 진행. 두번째 미팅은 삼성자산운용의 유아란, 윤상아 투자자와 컨퍼런스 콜 진행. 공통관심사는 추가거래 가능성임."

틀린 형태: "이번 주에는 총 2회의 미팅이 진행되었습니다. 첫 번째 미팅은 미래에셋자산운용의 이원준 투자자와 본사에서 대면으로 진행되었습니다."
