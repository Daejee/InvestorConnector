...
JSON 형식으로 응답하세요: {"meetingSummary": "내용", "commonInterests": "내용", "positiveFeedback": "내용", "concerns": "내용", "followUpRecommendations": "내용"}`
  ...
  async generateExpectedQuestions(pastMeetingsData: WeeklyMeetingData): Promise<ExpectedQuestionsAnalysis> {
    ...
    if (pastMeetingsData.meetings.length === 0) {
      return {
        expectedQuestions: [
          "Q. 회사의 전반적인 사업 현황과 최근 실적은 어떠한가요?",
          "Q. 올해와 내년 실적 전망 및 목표는 무엇인가요?",
          "Q. 주요 경쟁사 대비 경쟁력과 차별화 포인트는 무엇인가요?",
          "Q. 신규 사업 계획이나 투자 계획이 있다면 설명해주세요",
          "Q. ESG 경영 방침과 지속가능성 전략은 어떻게 되나요?",
          "Q. 현재 가장 큰 리스크 요인은 무엇인가요?",
          "Q. 배당정책이나 주주환원정책은 어떻게 되나요?",
          "Q. 글로벌 진출 계획이나 해외 사업 현황은?",
          "Q. 디지털 전환이나 기술 혁신 계획은 있나요?",
          "Q. 원자재 가격 상승이 실적에 미치는 영향은?",
          "Q. 금리 인상이 회사 운영에 미치는 영향은?",
          "Q. 주요 고객사와의 계약 현황은 어떠한가요?",
          "Q. 인수합병이나 사업 구조조정 계획이 있나요?",
          "Q. 현금흐름과 재무 건전성은 어떤 수준인가요?",
          "Q. 향후 성장 동력과 전략은 무엇인가요?"
        ]
      };
    }
